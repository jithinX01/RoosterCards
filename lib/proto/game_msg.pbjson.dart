...
@$core.Deprecated('Use gPActionDescriptor instead')
const GPAction$json = const {
  '1': 'GPAction',
  '2': const [
    const {'1': 'DRAW', '2': 0},
    const {'1': 'DISCARD', '2': 1},
...
/// Descriptor for `GPAction`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List gPActionDescriptor = $convert.base64Decode('CghHUEFjdGlvbhIICgREUkFXEAASCwoHRElTQ0FSRBAB');
...
const GameMessageClient$json = const {
  ...
  '2': const [
    ...
    const {'1': 'gameProgress', '3': 4, '4': 1, '5': 11, '6': '.game_message.GameProgress', '9': 0, '10': 'gameProgress'},
...
final $typed_data.Uint8List gameMessageClientDescriptor = $convert.base64Decode('');
...
@$core.Deprecated('Use gameProgressDescriptor instead')
const GameProgress$json = const {
  '1': 'GameProgress',
  '2': const [
    const {'1': 'action', '3': 1, '4': 1, '5': 14, '6': '.game_message.GPAction', '10': 'action'},
    const {'1': 'playerId', '3': 2, '4': 1, '5': 5, '10': 'playerId'},
    const {'1': 'newCard', '3': 3, '4': 1, '5': 5, '10': 'newCard'},
    const {'1': 'oldCard', '3': 4, '4': 1, '5': 5, '10': 'oldCard'},
    const {'1': 'tournamentId', '3': 5, '4': 1, '5': 5, '10': 'tournamentId'},
  ],
};

/// Descriptor for `GameProgress`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gameProgressDescriptor = $convert.base64Decode('CgxHYW1lUHJvZ3Jlc3MSLgoGYWN0aW9uGAEgASgOMhYuZ2FtZV9tZXNzYWdlLkdQQWN0aW9uUgZhY3Rpb24SGgoIcGxheWVySWQYAiABKAVSCHBsYXllcklkEhgKB25ld0NhcmQYAyABKAVSB25ld0NhcmQSGAoHb2xkQ2FyZBgEIAEoBVIHb2xkQ2FyZBIiCgx0b3VybmFtZW50SWQYBSABKAVSDHRvdXJuYW1lbnRJZA==');
...
final $typed_data.Uint8List gameMessageServerDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List startTournamentDescriptor = $convert.base64Decode('');
