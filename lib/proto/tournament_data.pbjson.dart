...
const TournamentData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'coins', '3': 19, '4': 1, '5': 5, '10': 'coins'},
    const {'1': 'playerIdOut', '3': 20, '4': 3, '5': 5, '10': 'playerIdOut'},
    const {'1': 'rewardCoins', '3': 21, '4': 1, '5': 5, '10': 'rewardCoins'},
  ],
...
final $typed_data.Uint8List tournamentDataDescriptor = $convert.base64Decode('');
...
const RummyTournamentData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'maxPointGame', '3': 5, '4': 1, '5': 8, '10': 'maxPointGame'},
    const {'1': 'maxPoint', '3': 6, '4': 1, '5': 5, '10': 'maxPoint'},
  ],
...
final $typed_data.Uint8List rummyTournamentDataDescriptor = $convert.base64Decode('');
